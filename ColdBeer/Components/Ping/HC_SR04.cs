...
namespace ColdBeer.Components.Ping
{
    ...
    public class HC_SR04
    {
        ...
        /// Convert ticks to distance using TicksToMm below
        /// </summary>
        ...
        /// <returns></returns>
        public double TicksToMm(long ticks)
        {
            return (double)ticks / mmConversion;
        }

        /// <summary>
        /// The ticks to mm conversion factor
        /// </summary>
        public double MmCoversionFactor
        {
            get
            {
                return mmConversion;
